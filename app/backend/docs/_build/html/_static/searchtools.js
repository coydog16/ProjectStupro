...
if (typeof splitQuery === 'undefined') {
    var splitQuery = (query) => query.split(/[^\p{Letter}\p{Number}_\p{Emoji_Presentation}]+/gu).filter((term) => term); // remove remaining empty strings
}
...
const Search = {
    ...
    _performSearch: (query, searchTerms, excludedTerms, highlightTerms, objectTerms) => {
        ...
        // lookup as object
        objectTerms.forEach((term) => normalResults.push(...Search.performObjectSearch(term, objectTerms)));
